%Add takeoff distance constraint to optimization problem.
...
%Static Margin
%The static margin is already guaranteed to be positive by the stability 
% constraint . However, a high static margin can lead to the aircraft 
% requiring large elevator deflection to pitch up or down, whereas low 
% static margin can make the aircraft too sensitive to elevator deflections. 
% Therefore, impose maximum and minimum values on the static margin.
...
%The competition rules restrict the takeoff distance to 100 ft.
